...
module.exports = base.extend({
  ...
  removeItem: function(e) { /*jshint ignore: line */
    this.collection.remove(this.model);
  },
  editItem: function(e) { /*jshint ignore: line */
    this.model.validationError = null;
    this.model.set("editing", true);
  },
  cancelEdit: function(e) { /*jshint ignore: line */
    this.model.validationError = null;
    this.model.set("editing", false);
  },
  saveItem: function(e) { /*jshint ignore: line */
